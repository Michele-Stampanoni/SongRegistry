...
contract('SongRegistry', function (accounts) {
   ...
   // Test 2
     ...
     let buyers[song] = await SongRegistryInstance.register
    ...
    //Test 3
     ...
     let song.length = await SongRegistryInstance.numberOfSongs(songs)
    ...
    let accounts[i] = await SongRegistryInstance.songBuyers(songId) 
